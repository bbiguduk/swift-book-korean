...
첫 번째 줄은
매크로의 이름과 매크로의 인수를 지정합니다 ---
이름은 `OptionSet`이고 인수는 가지고 있지 않습니다.
두 번째 줄은
...
해당 블럭들은 매크로가 올바르게 사용되지 않으면 오류가 발생합니다 ---
오류 메세지는 잘못된 호출 부분에서
컴파일 오류가 나타납니다.
예를 들어
