...
#### 부호없는 정수의 이동 동작 (Shifting Behavior for Unsigned Integers)
...
#### 부호있는 정수의 이동 동작 (Shifting Behavior for Signed Integers)
...
이번에는 부호 비트가 "음수"를 의미하는 `1` 이고 7개의 값 비트는 `128 - 4` 인 `124` 의 이진값을 가집니다:
