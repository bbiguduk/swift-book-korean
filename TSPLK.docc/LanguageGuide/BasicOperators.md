...
일반적인 코딩 에러를 방지하기 위해 여러 기능을 개선했습니다.
...
사용자 정의 연산자를 어떻게 정의하고
사용자 정의 타입을 위한 표준 연산자의 구현은 어떻게 하는지 설명합니다.
...
Swift는 코드에서 이런 종류의 에러를 피할 수 있도록 도와줍니다.
