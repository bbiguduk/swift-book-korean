...
사용자 정의 이니셜라이저는 초기화 하는 타입보다 더 낮거나 같은 접근 수준으로 할당할 수 있습니다. 유일한 예외는 <doc:Initialization#필수-이니셜라이저-Required-Initializers> 입니다. 필수 이니셜라이저는 자신이 속한 클래스와 동일한 접근 수준을 가져야 합니다.
